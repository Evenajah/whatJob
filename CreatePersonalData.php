...
<html>
<head>
    <title>CreatePersonalData</title>
    <meta charset="UTF-8">
...
<h2 class = "heading">CREATE RESUME</h2>
<h3 class = "heading">Please enter personal data before create resume.</h3>

<form name="addjob" action = "addPersonalData.php" method="POST" enctype="multipart/form-data">
<br>

<!--Name-->
    <label for="name" require>Name</label>
    <input type="text" name="Name" size = "40" required class="TextFrame"  >
    <span class="focus-input2" data-placeholder="Detail"></span>
    <br><br>


<!--LastName-->
<label for="name" require>LastName</label>
    <input type="text" name="LastName" size = "40" required class="TextFrame" >
    <br><br>
...
<!--Nationality-->
    ...
    <input type = "text" name="Nationality"  required  class="TextFrame">
    <br><br>


<!--Race-->
<label for="Race">Race</label>
    <input type = "text" name="Race"  required  class="TextFrame">
    <br><br>


<!--Weight-->
<label for="Weight">Weight</label>
    <input type = "number" name="Weight"  required  class="TextFrame">
    <br><br>


<!--height-->
<label for="height">Height</label>
    <input type = "number" name="Height"  required  class="TextFrame">
    <br><br>


<!--Birth-->
<label for="Birth">Birth</label>
    <input type = "date" name="Birth"  required  class="TextFrame" >
    <br><br>  
    
    
<!--Religion-->
<label for="Religion">Religion</label>
    <input type = "text" name="Religion"  required  class="TextFrame" >
    <br><br> 
...
<!--Status-->
    ...
    <select name="Status" required class="TextFrame">
...
<label for="Age">Age</label>
    <input type = "number" name="Age"  required  class="TextFrame" >
    <br><br>  
