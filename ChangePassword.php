...
<div class = "wrapMail">
<span class = "MailHead"><i class="fas fa-unlock-alt"></i></span>
<h2>CHANGE PASSWORD</h2>

<!--Form change password-->
    <form action = "ChangePasswordCheck.php" name = "inputChange" method="post">
    <br>
    <span class="iconPassword"><i class="fas fa-unlock-alt"></i></span>
    <input type = "password" class = "inputChangepass" name ="passwordOld" required placeholder = "Old password">
        <br><br>
    <span class="iconPassword"><i class="fas fa-unlock-alt"></i></span>
    <input type = "password" class = "inputChangepass" name = "passwordNew" required placeholder = "New password">
        <br><br><br>
      <input type = "submit" value = "CHANGE" class="btnchangePass" >
      <br><br><br>  
