...
<div class="w3-content" style="max-width:2000px;margin-top:40px">
    ...
    <h2>MY ACCOUNT</h2>
    <span><i class="fas fa-user-circle"></i>&nbsp;<?php echo $row_username ?> ID : <?php echo $row_userID ?></span><br><br>
    <a href = "Mailbox.php" class = "accountElement"><i class="fas fa-envelope"></i> Mailbox</a><br><br>
    <a href = "History.php" class = "accountElement"><i class="fas fa-history"></i> History</a><br><br>
    <a href = "ChangePassword.php" class = "accountElement"><i class="fas fa-lock-open"></i>Change password</a>
