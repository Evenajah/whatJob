  ...
  <div class="w3-third">
    ...
    <div class="w3-white w3-text-black w3-card-4">
      <div class="w3-display-container">
        <img src="./UserImage/<?php echo $Personal['image'] ;?>" style="width:100%" alt="Avatar">
      </div>
...
<!--form รับสมัคร-->
      <div class="w3-container">
            <form action="accept.php" name = "send" method="post">
                <input type="hidden" name="jobs_id" value ="<?php echo $jobs_id ;?>">
                <input type="hidden" name="user_host" value="<?php echo $row_userID //ส่งรหัสuserด้วยอินพุท hidden = "แฝง";?>">
