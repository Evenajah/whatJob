...
<h2 class = "heading">CREATE JOB</h2>
<h3 class = "heading">Please fill in the application form.</h3>
<br>
<form name="addjob" action = addjob.php method="POST" enctype="multipart/form-data">


<!--jobs_head-->
    <label for="่jobs_head">Topic</label>
    <input type="text" name="jobs_head" size = "40" required class="TextFrame" autofocus>
    <br><br>


<!--jobs_Image-->
    <label for="news_img">Image</label>
    <input type ="file"required name ="news_img">
    <br><br>


<!--jobs_detail-->
    <label for="jobs_data">Detail</label>
    <textarea name="jobs_data" size="50" rows = '5' required  class="TextFrame"></textarea>
    <br><br>
...
<!--jobs_Edu-->
    ...
    <select name="jobs_edu" required class="TextFrame">
        <?php
...
<!--jobs_location-->
    ...
    <textarea name="jobs_loca" size="50" required class="TextFrame"></textarea>
    <br><br>


 <!--experience-->   
    <label for="jobs_exp">Experience</label>
    <select name="jobs_exp" required class="TextFrame">
        <?php
