...
//ไม่มี ให้ Create ได้
        ...
        <a href="CreateResume.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">CREATE RESUME</a>
    <?php } ?>
...
<h3 class = "heading">Enter in fills to create resume</h3>

<form name="addjob" action = "addResume.php" method="POST" enctype="multipart/form-data">
<br>

<!--Address-->
    <label for="Address">Address</label>
    <textarea name = "Address" class="TextFrame" required></textarea>
    <br><br>
...
<label for="EducationName">Education Name</label>
    <input type="text" name= "EducationName" class="TextFrame" required>
    <br><br>
...
<label for="Skills">Skills</label>
    <textarea name= "Skills" class="TextFrame" required></textarea>
    <br><br>
...
<label for="Email">Email</label>
    <input type="Email" name="Email" required class= "TextFrame">
    <br><br>


<!--Tel.-->
<label for="Tel">Telephone</label>
    <input type="number" name="Tel" required class= "TextFrame">
    <br><br>
